"""Binomial-Bernoulli Mixture harmonium for clustering.
...
class MixtureBernoulliEmbedding(
    ...
    This embedding implements the conditional independence X perp K | Y by ensuring
...
@dataclass(frozen=True)
class BinomialBernoulliHarmonium(
...
class BinomialBernoulliMixture(
    ...
    Attributes:
        hrm: The underlying BinomialBernoulliHarmonium
    """

    hrm: BinomialBernoulliHarmonium
