...
Confirms LinearMap and matrix-rep machinery still work after the rename, and exercises MLPMap shape, parameter count, and ``__call__`` correctness.
"""
...
class TestMLPMap:
    """MLPMap dim, __call__, and initialization."""
